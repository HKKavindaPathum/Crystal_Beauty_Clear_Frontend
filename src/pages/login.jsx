    ...
    return (
        <div className="w-full min-h-screen bg-gradient-to-tr from-pink-50 via-white to-pink-100/50 dark:from-[#120D0E] dark:via-[#1A1012] dark:to-[#251317] flex justify-center items-center px-4 transition-colors duration-300 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-white/70 dark:bg-[#1C1416]/75 backdrop-blur-xl rounded-3xl shadow-xl p-8 border border-white/40 dark:border-white/5 flex flex-col items-center z-10 transition-all duration-300">
                <h2 className="font-heading text-3xl font-extrabold mb-1 text-secondary dark:text-[var(--color-dark-text)] text-center">Welcome Back</h2>
                <p className="font-main text-xs text-gray-500 dark:text-gray-400 mb-8 text-center">Unlock your beauty potential with BeautyClear</p>
                ...
                <button 
                    onClick={handleLogin} 
                    className="w-full py-4 mb-4 bg-accent hover:bg-accent-hover text-white font-bold rounded-xl transition duration-300 shadow-md cursor-pointer hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-accent/50 transform active:scale-[0.98]"
                >
                    Login
                </button>
                ...
                <button 
                    onClick={googleLogin} 
                    className="w-full py-4 mb-6 flex items-center justify-center border border-pink-100 dark:border-[var(--color-dark-border)] bg-white/80 dark:bg-[#1C1416]/80 text-secondary dark:text-[var(--color-dark-text)] font-semibold rounded-xl hover:bg-pink-50 dark:hover:bg-[#120D0E]/50 transition duration-300 cursor-pointer shadow-sm"
                >
                    <GrGoogle className="mr-3 text-xl text-red-500 animate-pulse" />
